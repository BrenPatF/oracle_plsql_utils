...
----------------------------------------------------------------------------------------------------
|  install_utils.sql      |  Creates common components, including Utils package, in lib schema     |
----------------------------------------------------------------------------------------------------
...
Components created, with NO synonyms or grants - only accessible within app schema:
    ...
    ============== =================================================================================
    Col_Group      Package called by main_col_group as a simple example to illustrate usage of Utils 
                   package. Also used in other utility-type modules
