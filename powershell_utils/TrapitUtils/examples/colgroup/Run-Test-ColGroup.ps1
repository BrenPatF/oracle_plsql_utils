<#**************************************************************************************************
Name: Run-Test-ColGroup.ps1                 Author: Brendan Furey                  Date: 11-Mar-2023
...
script name and the parent folder for the JavaScript npm node_modules folder, for the ColGroup
...
To run from the root folder:
    ...
    $ examples/colgroup/Run-Test-ColGroup
**************************************************************************************************#>
