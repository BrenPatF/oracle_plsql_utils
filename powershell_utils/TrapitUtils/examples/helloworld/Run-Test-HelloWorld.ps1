<#**************************************************************************************************
Name: Run-Test-HelloWorld.ps1               Author: Brendan Furey                  Date: 11-Mar-2023
...
script name and the parent folder for the JavaScript npm node_modules folder, for the HelloWorld
example. It creates a subfolder containing the formatted unit test results files, and returns a
summary of the results.

To run from the root folder:

    $ examples/helloworld/Run-Test-HelloWorld
**************************************************************************************************#>
Import-Module TrapitUtils
Test-Format ($PSScriptRoot + '/Test-HelloWorld.ps1') `
            ($PSScriptRoot + '/../..')