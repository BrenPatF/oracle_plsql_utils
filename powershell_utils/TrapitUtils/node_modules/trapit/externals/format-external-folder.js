...
To run from the root folder:
    ...
    $ node externals\test-externals-folder inpFolder

where:

- inpFolder = JSON results folder
***************************************************************************************************/
const [inpFolder,       Trapit           ] =
      [process.argv[2], require('trapit')];
const DEFAULT_COLORS = {h1: '#FFFF00', h2: '#2AE6C1', h3: '#33F0FF', h4: '#7DFF33'};
let colors = DEFAULT_COLORS;
//colors.h2 = '#a232a8';
Trapit.tabMkUTExternalResultsFolders(inpFolder, 'B', colors); // H/T/B : Format in HTML/Text/Both
