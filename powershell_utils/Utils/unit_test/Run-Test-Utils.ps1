<#**************************************************************************************************
Name: Run-Test-Utils.ps1                    Author: Brendan Furey                  Date: 11-Mar-2023
...
script name and the parent folder of the JavaScript node_modules npm root folder, for the 
Get-UT_TemplateObject function. It creates a subfolder containing the formatted unit test results
files, and returns a summary of the results.

To run from the root folder:

    $ unit_test/Run-Test-Get-UT_TemplateObject
**************************************************************************************************#>
Import-Module TrapitUtils
Test-Format ($PSScriptRoot + '/Test-Utils.ps1') `
            ($PSScriptRoot + '/../../TrapitUtils')